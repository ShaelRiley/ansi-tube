...
- **Persistent compact mode:** collapsing the controls persists across YouTube navigation. The compact bar follows YouTube's control visibility and also fades after 2.2 seconds of inactivity in windowed and Shorts playback; pointer activity reveals it. On Shorts, it moves to a lower safe area away from the volume slider.
